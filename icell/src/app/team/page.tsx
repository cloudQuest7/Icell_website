...
function TeamMemberCard({ member, delay }: TeamMemberCardProps) {
  return (
    <motion.div
      ...
      className="group relative h-[380px] rounded-2xl overflow-hidden bg-gradient-to-b from-neutral-900 to-neutral-950 border-2 border-neutral-800/50 hover:border-orange-500/50 transition-all duration-300"
    >
      {/* Hover glow effect */}
      ...
      <div className="relative z-10 flex flex-col items-center justify-center h-full p-6 space-y-4">
        ...
        <motion.div
          ...
          className="relative w-32 h-32 rounded-full overflow-hidden border-4 border-neutral-800/50 group-hover:border-orange-500/50 transition-all duration-300"
        >
          {/* Gradient fallback */}
          <div className="absolute inset-0 bg-gradient-to-br from-orange-500 via-blue-500 to-purple-500 flex items-center justify-center text-4xl font-bold text-white">
        ...
        {/* Name */}
        <h3 className="text-xl font-bold text-white text-center group-hover:text-orange-400 transition-colors duration-300">
          {member.name}
        </h3>
...
function SocialIcon({ href, icon }: { href: string; icon: string }) {
  ...
  return (
    <motion.a
      ...
      whileTap={{ scale: 0.9 }}
      className="w-10 h-10 rounded-full bg-neutral-800/80 backdrop-blur-sm flex items-center justify-center hover:bg-orange-500/20 transition-all duration-300 border border-neutral-700/50 hover:border-orange-500/50"
    >
      <span className="text-neutral-400 hover:text-orange-400 transition-colors">
